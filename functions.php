...
function wd_enqueue_scripts() {
	...
	wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Nunito+Sans:300,300i,400,400i,600,600i,700,700i,800,800i,900,900i', array(), CHILD_THEME_VERSION );
...
//* GENERIC -- Add custom logo to login page (optional)
...
//* GENERIC -- Add option to hide form labels in Gravity Forms
...
//* GENESIS -- Remove default stylesheet & add with modification date to break cache
...
//* GENESIS -- Rename Menus
add_theme_support( 'genesis-menus', array(
	'primary' => __( 'Primary Navigation Menu', 'genesis-sample' ),
	'secondary' => __( 'Footer Menu', 'genesis-sample' )
) );

//* GENESIS -- Remove secondary menu (added in sections/footer.php)
...
//* GENESIS -- Move Navigation within header wrap
